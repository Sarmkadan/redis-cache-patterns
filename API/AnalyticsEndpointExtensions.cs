...
public static class AnalyticsEndpointExtensions
{
    ...
    /// <returns>An API response containing filtered analytics data.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="endpoint"/> is <see langword="null"/></exception>
    /// <exception cref="ArgumentOutOfRangeException"><paramref name="maxAgeHours"/> must be greater than 0.</exception>
        ...
        bool includeReport = false)
    {
        ...
        if (maxAgeHours <= 0)
        {
            throw new ArgumentOutOfRangeException(nameof(maxAgeHours), "Maximum age must be greater than 0 hours.");
        }
    ...
    /// <returns>An API response containing filtered analytics data.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="endpoint"/> is <see langword="null"/></exception>
    /// <exception cref="ArgumentOutOfRangeException"><paramref name="minHitRate"/> must be between 0 and 1.</exception>
        ...
        bool includeReport = false)
    {
        ...
        if (minHitRate is < 0 or > 1)
        {
            throw new ArgumentOutOfRangeException(nameof(minHitRate), "Hit rate must be between 0 and 1.");
        }
    ...
    /// <param name="minAccessThreshold">Minimum number of accesses required for a key to be considered hot.</param>
    /// <returns>A read-only list of hot keys that meet the threshold criteria.</returns>
    /// <exception cref="ArgumentNullException">
